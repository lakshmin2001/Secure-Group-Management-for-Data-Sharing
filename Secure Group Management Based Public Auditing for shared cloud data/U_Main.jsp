...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style20">Secure Group Management Based Public Auditing for shared cloud data</h1>
      </div>
      ...
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            ...
            <div class="style2"></div>
            <div class="img">
              <div align="justify"><img src="images/img1.jpg" width="620" height="253" alt="" class="fl" /></div>
            </div>
