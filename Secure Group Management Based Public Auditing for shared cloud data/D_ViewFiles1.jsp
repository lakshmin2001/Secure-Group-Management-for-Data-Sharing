...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="D_Main.jsp">KGC</a></li>
          <li><a href="D_Login.jsp">LOGOUT</a></li>
        </ul>
      </div>
      <div class="logo">
        <h1 class="style3 style24">Secure Group Management Based Public Auditing for shared cloud data</h1>
      </div>
...
try 
	{		
              ...
              <tr>
				...
				<td width="155" bgcolor="#FF0000"><div align="center" class="style26">Private Key </div></td>
              </tr>
              <%
              ...
              <tr>
                ...
                <td><div align="center"><a href="D_FileDetails1.jsp?usid=<%=i%>"><%=s2%></a></div></td>
