    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="D_Login.jsp"><span>TPA</span></a></li>
          <li><a href="C_Login.jsp">CLOUD</a></li>
        </ul>
      </div>
      <div class="logo">
        <h1 class="style4">Secure Group Management Based Public Auditing for shared cloud data</h1>
      </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="D_Login.jsp">TPA</a></li>
          </ul>
        </div>
        </div>
      <div class="style2"></div>
